...
public class TimeUtils {
    ...
    public static String toString(Context context, Date date, boolean includeTime, boolean shortMonth) {
        GregorianCalendar cal = new GregorianCalendar();
        cal.setTime(date);
        return toString(context, cal, includeTime, shortMonth);
    }
     ...
     */
    public static String toString(Context context, Calendar date, boolean includeTime, boolean shortMonth) {
        Calendar now = Calendar.getInstance();
        int hourInt;
        final boolean is24 = DateFormat.is24HourFormat(context);
        if (is24)
    ...
    public static String toStringTime(Context context, Calendar time) {
        int hourInt;
        final boolean is24 = DateFormat.is24HourFormat(context);
        if (is24)
            hourInt = time.get(Calendar.HOUR_OF_DAY);
        else
            hourInt = time.get(Calendar.HOUR);
    ...
    public static String toStringTime(Context context, Date time) {
        GregorianCalendar cal = new GregorianCalendar();
        cal.setTime(time);
        return toStringTime(context, cal);
    }
